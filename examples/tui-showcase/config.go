...
// loadConfigFile loads configuration from ~/.config/layout-demo/config.yaml
...
func getConfigPath() string {
	...
	return filepath.Join(home, ".config", "layout-demo", "config.yaml")
}
...
func getDefaultLogPath() string {
	...
	return filepath.Join(home, ".local", "share", "layout-demo", "debug.log")
}
...
func createExampleConfig() error {
	...
	example := `# Layout Demo Configuration File
...
logging:
  ...
  file: "~/.local/share/layout-demo/debug.log"
`
