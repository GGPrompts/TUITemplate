...
type model struct {
	...
	// Dynamic panels demo state
	focusedPanel    string // Which panel is currently focused ("left", "right", "bottom")
	accordionMode   bool   // Whether accordion mode is enabled (focused panel gets 2x space)
	showThreePanel  bool   // Toggle between 2-panel and 3-panel layout

	// Panel content
	leftContent   []string // Content for left panel
	rightContent  []string // Content for right panel
	bottomContent []string // Content for bottom panel
