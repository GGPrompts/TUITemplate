...
// loadConfigFile loads configuration from ~/.config/termux-mobile-demo/config.yaml
...
func getConfigPath() string {
	...
	return filepath.Join(home, ".config", "termux-mobile-demo", "config.yaml")
}
...
func getDefaultLogPath() string {
	...
	return filepath.Join(home, ".local", "share", "termux-mobile-demo", "debug.log")
}
...
func createExampleConfig() error {
	...
	example := `# Termux Mobile Demo Configuration File
...
logging:
  ...
  file: "~/.local/share/termux-mobile-demo/debug.log"
`
